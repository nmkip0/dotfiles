local function vim_sexp_mappings()
	...
	nmap("<M-b>", "<Plug>(sexp_move_to_prev_element_head)", { desc = "Sexp move to prev element head" })
	xmap("<M-b>", "<Plug>(sexp_move_to_prev_element_head)", { desc = "Sexp move to prev element head" })
	omap("<M-b>", "<Plug>(sexp_move_to_prev_element_head)", { desc = "Sexp move to prev element head" })
	...
	nmap("<M-e>", "<Plug>(sexp_move_to_next_element_tail)", { desc = "Sexp move to next element tail" })
	xmap("<M-e>", "<Plug>(sexp_move_to_next_element_tail)", { desc = "Sexp move to next element tail" })
	omap("<M-e>", "<Plug>(sexp_move_to_next_element_tail)", { desc = "Sexp move to next element tail" })
